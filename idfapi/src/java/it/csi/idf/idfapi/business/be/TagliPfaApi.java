...
@Path("/private/tagli-pfa")
@Produces({ "application/json" })
public interface TagliPfaApi {
	...
	@Produces(MediaType.APPLICATION_JSON)
	Response saveStep1(TagliPfaStep1 body, @Context SecurityContext securityContext,
			@Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest)
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateStep1(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep1 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response saveStep2(TagliPfaStep2 body, @Context SecurityContext securityContext,
			@Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateStep2(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep2 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response saveStep3(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep3 body,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateStep3(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep3 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response saveStep4(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep4 body,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateStep4(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep4 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response saveStep5(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep5 body,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateStep5(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep5 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response cambioUtlizzatore(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep2 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	Response updateTipologiaIstanza(@PathParam("idIntervento") Integer idIntervento, TagliPfaStep5 dto,
			@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
			@Context HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException;
