...
import it.csi.idf.idfapi.business.be.TagliSelvicolturaliApi;
...
public class TagliSelvicolturaliApiImpl extends SpringSupportedResource implements TagliSelvicolturaliApi {
	...
	public Response getNumberOfNextStep(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			return Response.ok(tagliSelvicolturaliService.getNumberOfNextStep(idIntervento)).build();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Response deleteIntervento(Integer idIntervento, HttpServletRequest httpRequest) {
		try {
			tagliSelvicolturaliService.deleteIntervento(idIntervento);
	...
	public Response getStep1(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
			HttpServletRequest httpRequest) {
		try {
			return Response.ok(tagliSelvicolturaliService.getStep1(idIntervento)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	@Override
	public Response saveStep1(TagliSelvicolturaliStep1 body, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			PlainSezioneId record = tagliSelvicolturaliService.saveStep1(body, confUtente);
			return Response.status(Status.CREATED).entity(record).build();
		} catch (Exception e) {
			e.printStackTrace();
			logger.info("<---- saveStep1 ERROR: " + e);
			return Response.serverError().build();
		}
	}

	@Override
	public Response updateStep1(Integer idIntervento, TagliSelvicolturaliStep1 dto, SecurityContext securityContext,
		...
		try {
			...
			boolean updated = tagliSelvicolturaliService.updateStep1(dto, confUtente, idIntervento);
	...
	public Response getStep2(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			return Response.ok(tagliSelvicolturaliService.getStep2(idIntervento, confUtente)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	@Override
	public Response saveStep2(TagliSelvicolturaliStep2 body, SecurityContext securityContext, HttpHeaders httpHeaders,
			HttpServletRequest httpRequest) throws ValidationException, RecordNotUniqueException {
		ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
				userSessionDAO);
		...
		try {
			...
			TagliSelvicolturaliStep2 record = tagliSelvicolturaliService.saveStep2(body, confUtente);
			return Response.status(Status.CREATED).entity(record).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	@Override
	public Response updateStep2(Integer idIntervento, TagliSelvicolturaliStep2 dto, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			...
			boolean updated = tagliSelvicolturaliService.updateStep2(dto, confUtente, idIntervento);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	public Response getStep3(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			return Response.ok(tagliSelvicolturaliService.getStep3(idIntervento, confUtente)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	public Response getStep4(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			return Response.ok(tagliSelvicolturaliService.getStep4(idIntervento, confUtente)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	@Override
	public Response saveStep4(Integer idIntervento, TagliSelvicolturaliStep4 body, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
				userSessionDAO);
		...
		try {
			...
			TagliSelvicolturaliStep4 record = tagliSelvicolturaliService.saveStep4(body, confUtente);
			return Response.status(Status.CREATED).entity(record).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	@Override
	public Response updateStep4(Integer idIntervento, TagliSelvicolturaliStep4 dto, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			...
			boolean updated = tagliSelvicolturaliService.updateStep4(dto, confUtente, idIntervento);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	public Response getStep5(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			return Response.ok(tagliSelvicolturaliService.getStep5(idIntervento, confUtente)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	@Override
	public Response saveStep5(Integer idIntervento, TagliSelvicolturaliStep5 body, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
				userSessionDAO);
		...
		try {
			// validateBodyStep4(body, confUtente);
			body.getIntervento().setIdIntervento(idIntervento);
			TagliSelvicolturaliStep5 record = tagliSelvicolturaliService.saveStep5(body, confUtente);
	...
	@Override
	public Response updateStep5(Integer idIntervento, TagliSelvicolturaliStep5 dto, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			...
			boolean updated = tagliSelvicolturaliService.updateStep5(dto, confUtente, idIntervento);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	public Response recalculateParticelleIntervento(Integer idIntervento, HttpServletRequest httpRequest) {
		...
		try {
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			tagliSelvicolturaliService.recalculateParticelleIntervento(idIntervento, confUtente);
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	@Override
	public Response saveStep3(Integer idIntervento, TagliSelvicolturaliStep3 body, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
				userSessionDAO);
		...
		try {
			...
			TagliSelvicolturaliStep3 record = tagliSelvicolturaliService.saveStep3(body, confUtente);
			return Response.status(Status.CREATED).entity(record).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	@Override
	public Response updateStep3(Integer idIntervento, TagliSelvicolturaliStep3 dto, SecurityContext securityContext,
			HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			...
			boolean updated = tagliSelvicolturaliService.updateStep3(dto, confUtente, idIntervento);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	public Response checkAndInsertParticellaTagli(Integer idIntervento, PlainParticelleCatastali particellaCatasto,
		...
		try {
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			PlainParticelleCatastali response = tagliSelvicolturaliService.insertParticellaTagli(confUtente,
			...
			e.printStackTrace();
			logger.info("---checkAndInsertParticellaTagli ERROR "+e);
			return Response.serverError().entity(e.getMessage()).build();
		}
	}
	...
	public Response getRicadenze(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			TagliSelvicolturaliStep3 response = tagliSelvicolturaliService.getRicadenze(idIntervento);
	...
	public Response getTuttiElencaForIntervento(Integer idIntervento, HttpServletRequest httpRequest) {
		try {
			...
			return Response.ok(tagliSelvicolturaliService.getTuttiElencaForIntervento(idIntervento, isGestore)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	public Response invioIstanza(Integer idIntervento, ProfessionistaElencoAllegati body,
		...
		try {
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			tagliSelvicolturaliService.invioIstanzaTagli(idIntervento, body, confUtente);
			return Response.ok().build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	public Response invioEmail(Integer idIntervento, ProfessionistaElencoAllegati body,
		...
		try {
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			tagliSelvicolturaliService.invioIstanzaTagliEmail(idIntervento, body, confUtente);
			return Response.ok().build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	public Response getDataInvioIstanza(Integer idIntervento, HttpServletRequest httpRequest) {
		try {
			return Response.ok(tagliSelvicolturaliService.getDataInvioIstanza(idIntervento)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	public Response getCeoIstanza(Integer idIntervento, HttpServletRequest httpRequest) {
		try {
			return Response.ok(tagliSelvicolturaliService.getCeoIstanza(idIntervento)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	public Response getDocsGestoreByIntervento(Integer idIntervento, HttpServletRequest httpRequest) {
		try {
			return Response.ok(tagliSelvicolturaliService.getDocsGestoreByIntervento(idIntervento)).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
		}
	...
	public Response getInfoDrel(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
			HttpServletRequest httpRequest) {
		try {
			InfoDocsPfa info = tagliSelvicolturaliService.isDrelMancante(idIntervento);
	...
	public Response getDrel(Integer idIntervento, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			FatDocumentoAllegato drel = tagliSelvicolturaliService.getDrel(idIntervento);
	...
	public Response creaVarianteProroga(Integer idIntervento, Boolean isVariante, SecurityContext securityContext,
		...
		try {
			...
			PlainSezioneId res = tagliSelvicolturaliService.creaVarianteProroga(idIntervento, isVariante, confUtente);
	...
	public Response getInfoVarianteProroga(Integer idIntervento, SecurityContext securityContext,
		...
		try {
			...
			InfoVarianteProroga res = tagliSelvicolturaliService.getInfoVarianteProroga(idIntervento);
			return Response.ok(res).build();
		} catch (Exception e) {
			e.printStackTrace();
			return Response.serverError().build();
	...
	@Override
	public Response cambioUtlizzatore(Integer idIntervento, TagliSelvicolturaliStep2 dto,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			ConfigUtente confUtente = PlainAdpforHomeApiServiceImpl.getConfUtente(httpRequest, wrapperAdpforHomeDAO,
					userSessionDAO);
			boolean updated = tagliSelvicolturaliService.cambioUtilizzatore(dto, confUtente, idIntervento);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	public Response updateTitolaritaIntervento(Integer idIntervento, Integer idConfUtente,
		...
		try {
			tagliSelvicolturaliService.updateTitolaritaIntervento(idIntervento, idConfUtente);
	...
	@Override
	public Response updateTipologiaIstanza(Integer idIntervento, TagliSelvicolturaliStep5 dto,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest)
			throws ValidationException, RecordNotUniqueException {
		try {
			...
			TagliSelvicolturaliStep5 updated = tagliSelvicolturaliService.updateTipologiaIstanza(dto, confUtente);
		} catch (MultiErrorException e) {
			e.printStackTrace();
			return BaseResponses.errorResponse(e);
			// Not updated with no error => 404 not found
	...
	private void validateBodyStep1(TagliSelvicolturaliStep1 body, ConfigUtente confUtente) {
	...
	private void validateBodyStep2(TagliSelvicolturaliStep2 body, ConfigUtente confUtente) {
