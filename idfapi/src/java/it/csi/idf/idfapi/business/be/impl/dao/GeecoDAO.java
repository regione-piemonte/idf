...
public interface GeecoDAO {
	...
	public AreaDiSaggioDatiGeneraliDTO findADSByIdgeoPtAds(Long convertToLong) throws RecordNotFoundException;
	...
	public List<GeecoIvnTagliFeature> findGeometrieSelvicolturaliById(String[] idIntervento);
