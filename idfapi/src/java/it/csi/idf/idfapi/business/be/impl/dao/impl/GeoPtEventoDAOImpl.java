...
@Component
public class GeoPtEventoDAOImpl implements GeoPtEventoDAO {

	@Override
	public void insertGeoPtEvento(int fkEvento, Object geometria) {
	...
	@Override
	public void deleteGeoPtEvento(int idEvento) {
		StringBuilder sql = new StringBuilder();
