...
public final class IndexDtoFactory {
	 ...
	 * @return
	 */
	public static Property[] createContentProperties(MetadatiIndexDelega metadati) {
		final Property[] result = new Property[1];

		result[0] = new Property();
		result[0].setDataType(Constants.INDEX_TYPE_TEXT);
		result[0].setPrefixedName(MetadatiIndexDelega.META_ID_CONFIG_UTENTE);
		result[0].setValues(new String[] { metadati.getIdConfigUtente()});
