...
public class DichiarazioneTrasfSummaryMapper implements RowMapper<GeneratedFileTrasfParameters>{

	@Override
	public GeneratedFileTrasfParameters mapRow(ResultSet rs, int arg1) throws SQLException {
		
		GeneratedFileTrasfParameters genFileParams = new GeneratedFileTrasfParameters();
