...
import it.csi.idf.idfapi.dto.IntervPfaFat;
...
public class IntervPfaFatMapper implements RowMapper<IntervPfaFat> {
	
	static final Logger logger = Logger.getLogger(IntervPfaFatMapper.class);

	@Override
	public IntervPfaFat mapRow(ResultSet rs, int arg1) throws SQLException {

		IntervPfaFat interventoSelvcolt = new IntervPfaFat();
