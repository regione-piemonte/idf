...
public class OperatoreFormazioneProfessionale  implements java.io.Serializable {
    private it.csi.idf.idfapi.util.service.integration.aaep.CodiciATECO[] codici;

    private java.lang.String numeroCCIAA;

    private it.csi.idf.idfapi.util.service.integration.aaep.ComponenteFormazioneProfessionale[] componenteFP;
    ...
    public OperatoreFormazioneProfessionale(
           it.csi.idf.idfapi.util.service.integration.aaep.CodiciATECO[] codici,
           java.lang.String numeroCCIAA,
           it.csi.idf.idfapi.util.service.integration.aaep.ComponenteFormazioneProfessionale[] componenteFP,
     ...
     * @return codici
     */
    public it.csi.idf.idfapi.util.service.integration.aaep.CodiciATECO[] getCodici() {
        return codici;
    }
     ...
     * @param codici
     */
    public void setCodici(it.csi.idf.idfapi.util.service.integration.aaep.CodiciATECO[] codici) {
        this.codici = codici;
    }
     ...
     * @return componenteFP
     */
    public it.csi.idf.idfapi.util.service.integration.aaep.ComponenteFormazioneProfessionale[] getComponenteFP() {
        return componenteFP;
    }
     ...
     * @param componenteFP
     */
    public void setComponenteFP(it.csi.idf.idfapi.util.service.integration.aaep.ComponenteFormazioneProfessionale[] componenteFP) {
        this.componenteFP = componenteFP;
    }
