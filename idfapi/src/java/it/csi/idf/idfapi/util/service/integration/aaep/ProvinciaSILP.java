...
public class ProvinciaSILP  implements java.io.Serializable {
    ...
    private it.csi.idf.idfapi.util.service.integration.aaep.ComuneSILP[] listaComuniSILP;
    ...
    public ProvinciaSILP(
           ...
           it.csi.idf.idfapi.util.service.integration.aaep.ComuneSILP[] listaComuniSILP) {
     ...
     */
    public it.csi.idf.idfapi.util.service.integration.aaep.ComuneSILP[] getListaComuniSILP() {
        return listaComuniSILP;
    }
     ...
     */
    public void setListaComuniSILP(it.csi.idf.idfapi.util.service.integration.aaep.ComuneSILP[] listaComuniSILP) {
        this.listaComuniSILP = listaComuniSILP;
    }
