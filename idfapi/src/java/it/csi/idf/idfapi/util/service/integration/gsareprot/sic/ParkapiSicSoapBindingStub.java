...
public class ParkapiSicSoapBindingStub extends org.apache.axis.client.Stub implements ParkapiSic_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("sic", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("sic", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("sic", "Sic"));
        oper.setReturnClass(Sic[].class);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public Ricadenza[] determinaRicadenzaSuSicPerGeometriaGML(java.lang.String in0) throws java.rmi.RemoteException, UnrecoverableException, CSIException, SystemException, SICException {
        System.out.println("---determinaRicadenzaSuSicPerGeometriaGML 0----");
    	if (super.cachedEndpoint == null) {    		
            throw new org.apache.axis.NoEndPointException();
        }
    	System.out.println("---determinaRicadenzaSuSicPerGeometriaGML 1----");
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
        System.out.println("---determinaRicadenzaSuSicPerGeometriaGML 2----");
 try {
	 java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
 		
	 System.out.println("---determinaRicadenzaSuSicPerGeometriaGML 3----");
        if (_resp instanceof java.rmi.RemoteException) {
        	System.out.println("---determinaRicadenzaSuSicPerGeometriaGML 4----"+_resp);
            throw (java.rmi.RemoteException)_resp;
        }
        else {
            extractAttachments(_call);
	  ...
	  System.out.println("---determinaRicadenzaSuSicPerGeometriaGML axisFaultException----"+axisFaultException);
    if (axisFaultException.detail != null) {
        if (axisFaultException.detail instanceof java.rmi.RemoteException) {
              throw (java.rmi.RemoteException) axisFaultException.detail;
         }
