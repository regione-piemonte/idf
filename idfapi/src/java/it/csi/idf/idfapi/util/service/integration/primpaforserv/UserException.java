...
public class UserException  extends it.csi.idf.idfapi.util.service.integration.primpaforserv.CSIException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("primpa_istanze", "UserException"));
    }
