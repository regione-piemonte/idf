...
public class PermissionException  extends it.csi.idf.idfapi.util.service.integration.sigmater.sigwgssrv.UserException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sigwgssrvSigwgssrv", "PermissionException"));
    }
