...
@Component({
  selector: 'app-list-of-attachments-tagli',
  templateUrl: './list-of-attachments-tagli.component.html',
  styleUrls: ['./list-of-attachments-tagli.component.css']
})
export class ListOfAttachmentsTagliComponent implements OnInit {
