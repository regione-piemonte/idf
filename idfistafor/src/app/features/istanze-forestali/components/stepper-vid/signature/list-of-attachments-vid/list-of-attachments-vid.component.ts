...
@Component({
  selector: 'app-list-of-attachments-vid',
  templateUrl: './list-of-attachments-vid.component.html',
  styleUrls: ['./list-of-attachments-vid.component.css']
})
export class ListOfAttachmentsVidComponent implements OnInit {
