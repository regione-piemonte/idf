...
@Component({
  selector: 'persona-form-vid',
  templateUrl: './persona-form-vid.component.html',
  styleUrls: ['./persona-form-vid.component.css']
})
export class PersonaFormVidComponent implements OnInit, OnDestroy {
  ...
  checkTipotipoAccreditamento(personaDatiOption: string) {
    this.tipoAccreditamento = personaDatiOption === 'R'? 'Richiedente' : 'Professionista';
