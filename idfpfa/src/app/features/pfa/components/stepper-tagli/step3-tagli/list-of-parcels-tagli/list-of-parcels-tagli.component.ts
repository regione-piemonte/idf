...
import { IdfistaforHeaderHelper } from "src/app/features/idfistafor-header-helper";

@Component({
  selector: "list-of-parcels-tagli",
  templateUrl: "./list-of-parcels-tagli.component.html",
  styleUrls: ["./list-of-parcels-tagli.component.css"],
})
export class ListOfParcelsTagliComponent implements OnInit, OnDestroy {
