...
export class VincoloService {
  ...
  deleteIntervento(idIntervento: number) {
    return this.httpClient.delete(
      this.config.getBERootUrl(false) + `/vincolo/${idIntervento}`
    );
  }
  ...
  insertGeometryFromSingleParticella(
    ...
    return this.httpClient.post<any>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/${idIntervento}/inserisciParticella`,
      data
    );
  }
  ...
  putAdpfor(moduloDatiPersonali: UserChoiceModel) {
    return this.httpClient.put(
      this.config.getBERootUrl(false) + `/idfvincolo`,
      moduloDatiPersonali
    );
  }
  ...
  putTitolarita(idIntervento: number, idConfUtente: number) {
    return this.httpClient.put<any>(
      this.config.getBERootUrl(false) +
        `/vincolo/${idIntervento}/update/titolarita?idConfUtente=${idConfUtente}`,
      null
    );
  }
  ...
  getArrayOfInstance(page: number, limit: number, sortField?: string) {
    ...
    return this.httpClient.get<Content<ViewInstance[]>>(
      this.config.getBERootUrl(false) +
        `/vincolo/idfvincidro?tipoIstanzaId=${tipoIstanzaId}&page=${page}&limit=${limit}${
          sortQuery ? sortQuery : ""
        }`
    );
  }
  ...
  getSecondStepRicadenze(idIntervento: number): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/secondo/elencoRicadenze?idIntervento=${idIntervento}`
    );
  }

  getSuperfici(idIntervento: number): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(false)}/vincolo/${idIntervento}/superfici`
    );
  }
  ...
  getCoefficienteCalcoloImportoSupNonBoscata(): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/parametri/COEFF_CALCOLO_EURO_SUP_NON_BOSCATA_LR45`
    );
  }
  ...
  getCategorieProfessionali(): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(false)}/categorieProfessionali`
    );
  }

  getCategoriaProfessionaleById(id: number): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(false)}/categorieProfessionali/${id}`
    );
  }
  ...
  recalculateParticelle(idIntervento: number) {
    return this.httpClient.get<PlainSestoSezione>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/recalculate/particelle/${idIntervento}`
    );
  }
  ...
  deletePlainParticella(idIntervento: number, id: number) {
    return this.httpClient.delete(
      this.config.getBERootUrl(false) +
        `/catasti/vincolo/${idIntervento}?idGeoPlPropCatasto=${id}`
    );
  }
  ...
  getStep1(idIntervento: number) {
    return this.httpClient.get<UserCompanyDataModel>(
      this.config.getBERootUrl(false) + `/vincolo/${idIntervento}/prima`
    );
  }

  postStep1(data: UserCompanyDataModel) {
    return this.httpClient.post<any>(
      this.config.getBERootUrl(false) + `/vincolo/prima`,
      data
    );
  }
  ...
  getStep2(idIntervento: number): Observable<any> {
    return this.httpClient.get<any>(
      `${this.config.getBERootUrl(false)}/vincolo/${idIntervento}/seconda`
    );
  }
  ...
  getCauzione(idIntervento: number) {
    return this.httpClient.get<number>(
      this.config.getBERootUrl(false) + `/vincolo/${idIntervento}/cauzione`
    );
  }

  getAllDocuments(idIntervento: number): Observable<[DocumentoAllegato]> {
    return this.httpClient.get<[DocumentoAllegato]>(
      `${this.config.getBERootUrl(false)}/vincolo/${idIntervento}/elencaDich`
    );
  }
  ...
  getDocGestore(idIntervento: number): Observable<[DocumentoAllegato]> {
    return this.httpClient.get<[DocumentoAllegato]>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/${idIntervento}/elencoDocsGestore`
    );
  }
  ...
  uploadAllegato(
    ...
    return this.httpClient.post<any>(
      `${this.config.getBERootUrl(
        false
      )}/documenti/uploadVincolo?intervento=${idIntervento}&tipo=${tipo}`,
      file
    );
  }

  uploadRicevutePagamento(
    file: FormData,
    idIntervento: number
    ...
    return this.httpClient.post<DocumentoAllegato>(
      `${this.config.getBERootUrl(
        false
      )}/documenti/uploadRicevutePagamentoVincolo?intervento=${idIntervento}`,
      file
    );
  }
  ...
  downloadAllegato(idDocumento: number) {
    return this.httpClient.get(
      `${this.config.getBERootUrl(
        false
      )}/documenti/getVincoloDoc?idDocumento=${idDocumento}`,
  ...
  getinfoCauzione(idIntervento: number) {
    return this.httpClient.get<any>(
      this.config.getBERootUrl(false) +
        `/vincolo/cauzione?idIntervento=${idIntervento}`
    );
  }

  getUtenteForIstanza(idIntervento: number) {
    return this.httpClient.get(
      `${this.config.getBERootUrl(false)}/vincolo/bo/${idIntervento}/ceo`,
      { observe: "response" }
    );
  }
  ...
  autorizzataIstanza(datiAutoriz: any) {
    return this.httpClient.put<any>(
      this.config.getBERootUrl(false) + `/istanze/bo/vincolo/autorizzata`,
      datiAutoriz
    );
  }
  ...
  saveOrDeleteIstanzaTaglio(
    idIntervento: number,
    istanzaTaglio: IstanzaTaglio
  ) {
    return this.httpClient.put<IstanzaTaglio[]>(
      this.config.getBERootUrl(false) +
        `/vincolo/update/istanzaTaglio?idIntervento=${idIntervento}`,
      istanzaTaglio
    );
  }

  getIstanzeTaglioByIdIntervento(
    idIntervento: number
  ): Observable<IstanzaTaglio[]> {
    return this.httpClient.get<IstanzaTaglio[]>(
      `${this.config.getBERootUrl(
        false
      )}/vincolo/load/istanzeTaglio?idIntervento=${idIntervento}`
    );
  }

  isNamePresent(name: string, array: DocumentoAllegato[]): boolean {
    let elems = array.filter((elem) => {
      name.split(" - ")[0] == elem.nomeAllegato.split(" - ")[0];
    });
