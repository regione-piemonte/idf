...
export class ChiusuraInformazioni {
    ...
    public superficieTagliataInRiduzione?: number;
    public stimaValoreLotto?: number;
    public valoreDellAsta?: number;
    public flgConformeDeroga?: string;
}