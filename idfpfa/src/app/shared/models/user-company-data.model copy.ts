...
export class UserCompanyDataModel {
  constructor(
    ...
    public idSoggetto?: number,
    public flgEntePubblico?: boolean,
    ...
    public fkComune?: any,
    public numAlboForestale?: string,

    public nrIscrizioneOrdine?: string,
    public provIscrizioneOrdine?: string,
    public nrMartelloForestale?: string
